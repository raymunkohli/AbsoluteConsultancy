    ...
    <div id="base" class="">
      ...
      <div id="u15" class="ax_default">
        ...
        <div id="u16" class="ax_default table_cell">
          <img id="u16_img" class="img " src="images/receptionist_screen/u16.png"/>
          <div id="u16_text" class="text ">
            <p><span>Task ID</span></p>
          </div>
        </div>

        <!-- Unnamed (Table Cell) -->
        <div id="u17" class="ax_default table_cell">
          <img id="u17_img" class="img " src="images/receptionist_screen/u17.png"/>
          <div id="u17_text" class="text ">
            <p><span>Task Desc</span></p>
          </div>
        </div>

        <!-- Unnamed (Table Cell) -->
        <div id="u18" class="ax_default table_cell">
          <img id="u18_img" class="img " src="images/receptionist_screen/u18.png"/>
        ...
        <div id="u19" class="ax_default table_cell">
          <img id="u19_img" class="img " src="images/receptionist_screen/u19.png"/>
        ...
        <div id="u20" class="ax_default table_cell">
          <img id="u20_img" class="img " src="images/receptionist_screen/u20.png"/>
        ...
        <div id="u21" class="ax_default table_cell">
          <img id="u21_img" class="img " src="images/receptionist_screen/u21.png"/>
          <div id="u21_text" class="text ">
            <p><span>Duration (min)</span></p>
          </div>
        </div>

        <!-- Unnamed (Table Cell) -->
        <div id="u22" class="ax_default table_cell">
          <img id="u22_img" class="img " src="images/receptionist_screen/u22.png"/>
        ...
        <div id="u23" class="ax_default table_cell">
          <img id="u23_img" class="img " src="images/receptionist_screen/u16.png"/>
        ...
        <div id="u24" class="ax_default table_cell">
          <img id="u24_img" class="img " src="images/receptionist_screen/u17.png"/>
          <div id="u24_text" class="text ">
            <p><span>Black and white film processing</span></p>
          </div>
        </div>

        <!-- Unnamed (Table Cell) -->
        <div id="u25" class="ax_default table_cell">
          <img id="u25_img" class="img " src="images/receptionist_screen/u18.png"/>
          <div id="u25_text" class="text ">
            <p><span>Development area</span></p>
          </div>
        </div>

        <!-- Unnamed (Table Cell) -->
        <div id="u26" class="ax_default table_cell">
          <img id="u26_img" class="img " src="images/receptionist_screen/u19.png"/>
        ...
        <div id="u27" class="ax_default table_cell">
          <img id="u27_img" class="img " src="images/receptionist_screen/u20.png"/>
        ...
        <div id="u28" class="ax_default table_cell">
          <img id="u28_img" class="img " src="images/receptionist_screen/u21.png"/>
        ...
        <div id="u29" class="ax_default table_cell">
          <img id="u29_img" class="img " src="images/receptionist_screen/u22.png"/>
        ...
        <div id="u30" class="ax_default table_cell">
          <img id="u30_img" class="img " src="images/receptionist_screen/u30.png"/>
        ...
        <div id="u31" class="ax_default table_cell">
          <img id="u31_img" class="img " src="images/receptionist_screen/u31.png"/>
          <div id="u31_text" class="text ">
            <p><span>Colour transparency processing</span></p>
          </div>
        </div>

        <!-- Unnamed (Table Cell) -->
        <div id="u32" class="ax_default table_cell">
          <img id="u32_img" class="img " src="images/receptionist_screen/u32.png"/>
        ...
        <div id="u33" class="ax_default table_cell">
          <img id="u33_img" class="img " src="images/receptionist_screen/u33.png"/>
        ...
        <div id="u34" class="ax_default table_cell">
          <img id="u34_img" class="img " src="images/receptionist_screen/u34.png"/>
          <div id="u34_text" class="text ">
            <p><span>110.30</span></p>
          </div>
        </div>

        <!-- Unnamed (Table Cell) -->
        <div id="u35" class="ax_default table_cell">
          <img id="u35_img" class="img " src="images/receptionist_screen/u35.png"/>
        ...
        <div id="u36" class="ax_default table_cell">
          <img id="u36_img" class="img " src="images/receptionist_screen/u36.png"/>
      ...
      <div id="u37" class="ax_default button">
        ...
        <div id="u37_text" class="text ">
          <p><span>Add tasks to job</span></p>
        </div>
      </div>
