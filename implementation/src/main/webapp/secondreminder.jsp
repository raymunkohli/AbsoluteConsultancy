...
<fmt:formatDate var="date" value="${now}"  />
      ...
      <div id="u9" class="ax_default label">
        ...
        <div id="u9_text" class="text ">
          <p><span>It appears that we still have not received payment of the above invoice, </span></p><p><span> which was posted to you on 18th December 2017,  </span></p><p><span>for photographic work done in our laboratory, despite a reminder letter posted to you 1 month later. </span></p>
