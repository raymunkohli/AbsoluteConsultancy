    ...
    public ResultSet doSearchForCustQuery(String Query) {
        try {
            ...
            String query = "SELECT customer.customerID, customer.name, customer.surname, "
                    ...
                    + "fixeddiscount.percentDiscount, band.discount,discount.discountType,valuedcustomer.CustomercustomerID \n"
                    + "FROM customer \n"
                    ...
                    + "LEFT JOIN flexiblediscount ON flexiblediscount.DiscountdiscountID = discount.discountID \n"
