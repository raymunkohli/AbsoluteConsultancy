...
public class generatePerformanceReportServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String Err = "nothing";
        if(request.getParameter("CopyRoom")==null && request.getParameter("Finishing") == null
                && request.getParameter("Packing")==null && request.getParameter("Development") ==null){
            Err = "Select a Department";
        }
        if(request.getParameter("dayShift")==null && request.getParameter("nightShift")==null){
